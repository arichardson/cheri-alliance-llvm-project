...
# RV32-REL:      .rela.dyn {
# RV32-REL-NEXT:   0x12244 R_RISCV_TLS_DTPMOD32 evar 0x0
# RV32-REL-NEXT:   0x12248 R_RISCV_TLS_DTPREL32 evar 0x0
# RV32-REL-NEXT:   0x12250 R_RISCV_TLS_TPREL32 evar 0x0
# RV32-REL-NEXT: }

# RV32-SO-REL:      .rela.dyn {
# RV32-SO-REL-NEXT:   0x227C R_RISCV_TLS_DTPMOD32 - 0x0
# RV32-SO-REL-NEXT:   0x2290 R_RISCV_TLS_TPREL32 - 0x4
# RV32-SO-REL-NEXT:   0x2274 R_RISCV_TLS_DTPMOD32 evar 0x0
# RV32-SO-REL-NEXT:   0x2278 R_RISCV_TLS_DTPREL32 evar 0x0
# RV32-SO-REL-NEXT:   0x2280 R_RISCV_TLS_TPREL32 evar 0x0
# RV32-SO-REL-NEXT: }

# RV32-GOT: section '.got':
# RV32-GOT-NEXT: 0x00012240 e0210100 00000000 00000000 01000000
# RV32-GOT-NEXT: 0x00012250 04000000 00000000 00000000 00000000
...
# RV32-SO-GOT-NEXT: 0x00002280 04000000 00000000 00000000 00000000
...
# RV64-REL:      .rela.dyn {
# RV64-REL-NEXT:   0x123B8 R_RISCV_TLS_DTPMOD64 evar 0x0
# RV64-REL-NEXT:   0x123C0 R_RISCV_TLS_DTPREL64 evar 0x0
# RV64-REL-NEXT:   0x123D0 R_RISCV_TLS_TPREL64 evar 0x0
# RV64-REL-NEXT: }

# RV64-SO-REL:      .rela.dyn {
# RV64-SO-REL-NEXT:   0x2418 R_RISCV_TLS_DTPMOD64 - 0x0
# RV64-SO-REL-NEXT:   0x2440 R_RISCV_TLS_TPREL64 - 0x4
# RV64-SO-REL-NEXT:   0x2408 R_RISCV_TLS_DTPMOD64 evar 0x0
# RV64-SO-REL-NEXT:   0x2410 R_RISCV_TLS_DTPREL64 evar 0x0
...
# RV64-GOT-NEXT: 0x000123c0 00000000 00000000 01000000 00000000
# RV64-GOT-NEXT: 0x000123d0 04000000 00000000 00000000 00000000
# RV64-GOT-NEXT: 0x000123e0 00000000 00000000 00000000 00000000
...
# RV64-SO-GOT-NEXT: 0x00002420 04000000 00000000 00000000 00000000
# RV64-SO-GOT-NEXT: 0x00002430 00000000 00000000 00000000 00000000
