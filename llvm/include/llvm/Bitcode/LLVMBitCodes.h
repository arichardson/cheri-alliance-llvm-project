...
enum AttributeKindCodes {
  ...
  ATTR_KIND_NO_EXT = 99,
  ATTR_KIND_HAS_SIDE_EFFECTS = 100,
  ATTR_KIND_MUST_PRESERVE_CHERI_TAGS = 101,
  ATTR_KIND_NO_PRESERVE_CHERI_TAGS = 102,
  ATTR_KIND_NO_CAP_RELOCS = 103,
  ATTR_KIND_DONT_SEAL = 104,
};
