...
enum AttributeKindCodes {
  ...
  ATTR_KIND_HAS_SIDE_EFFECTS = 97,
  ATTR_KIND_MUST_PRESERVE_CHERI_TAGS = 98,
  ATTR_KIND_NO_PRESERVE_CHERI_TAGS = 99,
  ATTR_KIND_NO_CAP_RELOCS = 100,
  ATTR_KIND_DONT_SEAL = 101,
};
