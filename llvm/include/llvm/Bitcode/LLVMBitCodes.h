...
enum AttributeKindCodes {
  ...
  ATTR_KIND_HAS_SIDE_EFFECTS = 102,
  ATTR_KIND_MUST_PRESERVE_CHERI_TAGS = 103,
  ATTR_KIND_NO_PRESERVE_CHERI_TAGS = 104,
  ATTR_KIND_NO_CAP_RELOCS = 105,
  ATTR_KIND_DONT_SEAL = 106,
};
