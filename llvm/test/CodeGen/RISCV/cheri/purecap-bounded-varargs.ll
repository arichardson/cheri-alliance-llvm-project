...
entry:
  ...
  call void @llvm.va_copy.p200(i8 addrspace(200)* nonnull %1, i8 addrspace(200)* nonnull %0)
  call void @llvm.lifetime.end.p200(i64 16, i8 addrspace(200)* nonnull %0) #0
  %2 = load i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* %retval, align 16
  ret i8 addrspace(200)* %2
}

declare void @llvm.va_copy.p200(i8 addrspace(200)*, i8 addrspace(200)*) addrspace(200) #0
