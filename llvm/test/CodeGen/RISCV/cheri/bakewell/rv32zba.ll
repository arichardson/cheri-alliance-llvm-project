...
; ZCHERIPURECAP:       # %bb.0:
; ZCHERIPURECAP-NEXT:    slli a2, a0, 1
; ZCHERIPURECAP-NEXT:    slli a0, a0, 3
; ZCHERIPURECAP-NEXT:    sub a0, a0, a2
; ZCHERIPURECAP-NEXT:    add a0, a0, a1
; ZCHERIPURECAP-NEXT:    ret
;
...
; ZCHERIPURECAP:       # %bb.0:
; ZCHERIPURECAP-NEXT:    slli a2, a0, 2
...
; ZCHERIPURECAP:       # %bb.0:
; ZCHERIPURECAP-NEXT:    slli a2, a0, 3
; ZCHERIPURECAP-NEXT:    slli a0, a0, 5
; ZCHERIPURECAP-NEXT:    sub a0, a0, a2
; ZCHERIPURECAP-NEXT:    add a0, a0, a1
; ZCHERIPURECAP-NEXT:    ret
;
