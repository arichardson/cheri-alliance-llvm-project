...
; RV64P670-NEXT:    add t5, t2, s0
; RV64P670-NEXT:    add s0, a2, a6
; RV64P670-NEXT:    add t4, s0, t3
; RV64P670-NEXT:    add s0, a4, a6
; RV64P670-NEXT:    csrr t3, vlenb
; RV64P670-NEXT:    add t6, s0, s1
; RV64P670-NEXT:    sltu s1, a0, t4
; RV64P670-NEXT:    sltu s0, a2, t5
; RV64P670-NEXT:    slli t4, t3, 1
; RV64P670-NEXT:    and s0, s0, s1
; RV64P670-NEXT:    or s1, a1, a3
; RV64P670-NEXT:    slti s1, s1, 0
; RV64P670-NEXT:    or s2, s0, s1
; RV64P670-NEXT:    sltu s1, a0, t6
; RV64P670-NEXT:    sltu s0, a4, t5
; RV64P670-NEXT:    and s0, s0, s1
; RV64P670-NEXT:    or s1, a1, a5
; RV64P670-NEXT:    slti s1, s1, 0
; RV64P670-NEXT:    or s0, s0, s1
; RV64P670-NEXT:    li s1, 32
; RV64P670-NEXT:    maxu s1, t4, s1
; RV64P670-NEXT:    or s0, s2, s0
...
; RV64X60-NEXT:    or s2, t4, s1
; RV64X60-NEXT:    or s0, a1, a5
; RV64X60-NEXT:    slti s0, s0, 0
; RV64X60-NEXT:    or s0, t5, s0
; RV64X60-NEXT:    slli t4, t3, 1
; RV64X60-NEXT:    maxu s1, t4, t6
...
; RV64X60-NEXT:    # in Loop: Header=BB0_4 Depth=1
; RV64X60-NEXT:    slli s1, t3, 28
; RV64X60-NEXT:    sub s1, s1, t4
...
; RV64-NEXT:    add s1, a2, a6
; RV64-NEXT:    add s0, a4, a6
; RV64-NEXT:    csrr t4, vlenb
; RV64-NEXT:    li t2, 32
; RV64-NEXT:    slli t3, t1, 32
; RV64-NEXT:    slli t1, t4, 1
; RV64-NEXT:    srli t3, t3, 32
; RV64-NEXT:    mul t5, a3, t3
; RV64-NEXT:    add s1, s1, t5
; RV64-NEXT:    mul t6, a1, t3
; RV64-NEXT:    mul t3, a5, t3
; RV64-NEXT:    add t6, t0, t6
...
; RV64-NEXT:    li t2, 0
; RV64-NEXT:    li t3, 0
; RV64-NEXT:    sltu s1, a0, s1
; RV64-NEXT:    sltu s2, a2, t6
; RV64-NEXT:    and s1, s1, s2
; RV64-NEXT:    sltu s0, a0, s0
; RV64-NEXT:    sltu t6, a4, t6
; RV64-NEXT:    and t6, s0, t6
; RV64-NEXT:    or s0, a1, a3
; RV64-NEXT:    slti s0, s0, 0
; RV64-NEXT:    or s0, s1, s0
; RV64-NEXT:    or s1, a1, a5
; RV64-NEXT:    slti s1, s1, 0
; RV64-NEXT:    or t6, t6, s1
; RV64-NEXT:    sltu t5, a6, t5
; RV64-NEXT:    slli t4, t4, 28
; RV64-NEXT:    sub s1, t4, t1
; RV64-NEXT:    or t4, s0, t6
; RV64-NEXT:    or t4, t5, t4
; RV64-NEXT:    andi t4, t4, 1
; RV64-NEXT:    and t5, s1, a6
; RV64-NEXT:    j .LBB0_6
