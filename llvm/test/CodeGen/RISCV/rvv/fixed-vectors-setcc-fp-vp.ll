...
; ZVFHMIN32-NEXT:    mul a0, a0, a1
; ZVFHMIN32-NEXT:    add a0, sp, a0
; ZVFHMIN32-NEXT:    lh s9, 848(a0) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    csrr a0, vlenb
...
; ZVFHMIN32-NEXT:    vmv.x.s s2, v3
; ZVFHMIN32-NEXT:    fmv.h.x fa5, t5
; ZVFHMIN32-NEXT:    fmv.h.x fa4, t6
; ZVFHMIN32-NEXT:    feq.h t5, fa5, fa4
; ZVFHMIN32-NEXT:    sb t5, 174(sp)
; ZVFHMIN32-NEXT:    lh s10, 730(sp)
; ZVFHMIN32-NEXT:    lh s11, 474(sp)
; ZVFHMIN32-NEXT:    vmv.x.s t6, v31
; ZVFHMIN32-NEXT:    vmv.x.s t5, v5
; ZVFHMIN32-NEXT:    fmv.h.x fa5, s10
; ZVFHMIN32-NEXT:    fmv.h.x fa4, s11
; ZVFHMIN32-NEXT:    feq.h s10, fa5, fa4
; ZVFHMIN32-NEXT:    sb s10, 173(sp)
; ZVFHMIN32-NEXT:    lh s10, 728(sp)
; ZVFHMIN32-NEXT:    lh s11, 472(sp)
; ZVFHMIN32-NEXT:    vmv.x.s a2, v9
; ZVFHMIN32-NEXT:    vmv.x.s a4, v11
; ZVFHMIN32-NEXT:    fmv.h.x fa5, s10
; ZVFHMIN32-NEXT:    fmv.h.x fa4, s11
; ZVFHMIN32-NEXT:    feq.h s10, fa5, fa4
; ZVFHMIN32-NEXT:    sb s10, 172(sp)
; ZVFHMIN32-NEXT:    lh s10, 726(sp)
; ZVFHMIN32-NEXT:    lh s11, 470(sp)
; ZVFHMIN32-NEXT:    vmv.x.s a3, v13
; ZVFHMIN32-NEXT:    vmv.x.s a5, v29
; ZVFHMIN32-NEXT:    fmv.h.x fa5, s10
; ZVFHMIN32-NEXT:    fmv.h.x fa4, s11
; ZVFHMIN32-NEXT:    feq.h s10, fa5, fa4
; ZVFHMIN32-NEXT:    sb s10, 171(sp)
; ZVFHMIN32-NEXT:    lh s10, 724(sp)
; ZVFHMIN32-NEXT:    lh a0, 468(sp)
; ZVFHMIN32-NEXT:    vmv.x.s ra, v27
...
; ZVFHMIN32-NEXT:    feq.h s6, fa5, fa1
...
; ZVFHMIN32-NEXT:    lh a3, 458(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa4, a5
; ZVFHMIN32-NEXT:    feq.h a4, fa2, fa4
; ZVFHMIN32-NEXT:    fmv.h.x fa4, a1
...
; ZVFHMIN32-NEXT:    lh a3, 456(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa3, ra
; ZVFHMIN32-NEXT:    feq.h a5, fa5, fa3
; ZVFHMIN32-NEXT:    fmv.h.x fa5, a1
; ZVFHMIN32-NEXT:    fmv.h.x fa3, a3
...
; ZVFHMIN32-NEXT:    lh a3, 454(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa3, s11
...
; ZVFHMIN32-NEXT:    sb t5, 193(sp)
; ZVFHMIN32-NEXT:    sb a5, 194(sp)
; ZVFHMIN32-NEXT:    sb a4, 195(sp)
; ZVFHMIN32-NEXT:    sb a3, 196(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa5, a0
; ZVFHMIN32-NEXT:    fmv.h.x fa4, a1
; ZVFHMIN32-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN32-NEXT:    sb a2, 197(sp)
; ZVFHMIN32-NEXT:    sb t6, 198(sp)
; ZVFHMIN32-NEXT:    sb s2, 199(sp)
...
; ZVFHMIN32-NEXT:    mul a5, a5, s3
; ZVFHMIN32-NEXT:    add a5, sp, a5
; ZVFHMIN32-NEXT:    addi a5, a5, 848
; ZVFHMIN32-NEXT:    vl2r.v v8, (a5) # Unknown-size Folded Reload
; ZVFHMIN32-NEXT:    vmv.x.s a5, v8
...
; ZVFHMIN32-NEXT:    fmv.h.x fa4, a1
; ZVFHMIN32-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN32-NEXT:    lw a1, 104(sp) # 4-byte Folded Reload
; ZVFHMIN32-NEXT:    fmv.h.x fa5, a1
...
; ZVFHMIN64-NEXT:    mul a0, a0, a1
; ZVFHMIN64-NEXT:    add a0, sp, a0
; ZVFHMIN64-NEXT:    lh s9, 800(a0) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    csrr a0, vlenb
...
; ZVFHMIN64-NEXT:    vmv.x.s s2, v3
; ZVFHMIN64-NEXT:    fmv.h.x fa5, t5
; ZVFHMIN64-NEXT:    fmv.h.x fa4, t6
; ZVFHMIN64-NEXT:    feq.h t5, fa5, fa4
; ZVFHMIN64-NEXT:    sb t5, 174(sp)
; ZVFHMIN64-NEXT:    lh s10, 730(sp)
; ZVFHMIN64-NEXT:    lh s11, 474(sp)
; ZVFHMIN64-NEXT:    vmv.x.s t6, v31
; ZVFHMIN64-NEXT:    vmv.x.s t5, v5
; ZVFHMIN64-NEXT:    fmv.h.x fa5, s10
; ZVFHMIN64-NEXT:    fmv.h.x fa4, s11
; ZVFHMIN64-NEXT:    feq.h s10, fa5, fa4
; ZVFHMIN64-NEXT:    sb s10, 173(sp)
; ZVFHMIN64-NEXT:    lh s10, 728(sp)
; ZVFHMIN64-NEXT:    lh s11, 472(sp)
; ZVFHMIN64-NEXT:    vmv.x.s a2, v9
; ZVFHMIN64-NEXT:    vmv.x.s a4, v11
; ZVFHMIN64-NEXT:    fmv.h.x fa5, s10
; ZVFHMIN64-NEXT:    fmv.h.x fa4, s11
; ZVFHMIN64-NEXT:    feq.h s10, fa5, fa4
; ZVFHMIN64-NEXT:    sb s10, 172(sp)
; ZVFHMIN64-NEXT:    lh s10, 726(sp)
; ZVFHMIN64-NEXT:    lh s11, 470(sp)
; ZVFHMIN64-NEXT:    vmv.x.s a3, v13
; ZVFHMIN64-NEXT:    vmv.x.s a5, v29
; ZVFHMIN64-NEXT:    fmv.h.x fa5, s10
; ZVFHMIN64-NEXT:    fmv.h.x fa4, s11
; ZVFHMIN64-NEXT:    feq.h s10, fa5, fa4
; ZVFHMIN64-NEXT:    sb s10, 171(sp)
; ZVFHMIN64-NEXT:    lh s10, 724(sp)
; ZVFHMIN64-NEXT:    lh a0, 468(sp)
; ZVFHMIN64-NEXT:    vmv.x.s ra, v27
...
; ZVFHMIN64-NEXT:    feq.h s6, fa5, fa1
...
; ZVFHMIN64-NEXT:    lh a3, 458(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa4, a5
; ZVFHMIN64-NEXT:    feq.h a4, fa2, fa4
; ZVFHMIN64-NEXT:    fmv.h.x fa4, a1
...
; ZVFHMIN64-NEXT:    lh a3, 456(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa3, ra
; ZVFHMIN64-NEXT:    feq.h a5, fa5, fa3
; ZVFHMIN64-NEXT:    fmv.h.x fa5, a1
; ZVFHMIN64-NEXT:    fmv.h.x fa3, a3
...
; ZVFHMIN64-NEXT:    lh a3, 454(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa3, s11
...
; ZVFHMIN64-NEXT:    sb t5, 193(sp)
; ZVFHMIN64-NEXT:    sb a5, 194(sp)
; ZVFHMIN64-NEXT:    sb a4, 195(sp)
; ZVFHMIN64-NEXT:    sb a3, 196(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa5, a0
; ZVFHMIN64-NEXT:    fmv.h.x fa4, a1
; ZVFHMIN64-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN64-NEXT:    sb a2, 197(sp)
; ZVFHMIN64-NEXT:    sb t6, 198(sp)
; ZVFHMIN64-NEXT:    sb s2, 199(sp)
...
; ZVFHMIN64-NEXT:    mul a5, a5, s3
; ZVFHMIN64-NEXT:    add a5, sp, a5
; ZVFHMIN64-NEXT:    addi a5, a5, 800
; ZVFHMIN64-NEXT:    vl2r.v v8, (a5) # Unknown-size Folded Reload
; ZVFHMIN64-NEXT:    vmv.x.s a5, v8
...
; ZVFHMIN64-NEXT:    fmv.h.x fa4, a1
; ZVFHMIN64-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN64-NEXT:    ld a1, 80(sp) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    fmv.h.x fa5, a1
