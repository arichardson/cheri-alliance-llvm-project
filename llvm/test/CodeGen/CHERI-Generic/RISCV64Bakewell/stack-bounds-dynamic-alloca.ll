...
; RUN: opt -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+zcheripurecap,+cap-mode,+f,+d -cheri-bound-allocas -o - -S %s | FileCheck %s
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+zcheripurecap,+cap-mode,+f,+d -O0 %s -o - | FileCheck %s -check-prefix ASM
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+zcheripurecap,+cap-mode,+f,+d -O2 %s -o - | FileCheck %s -check-prefix ASM-OPT
; reduced C test case:
; __builtin_va_list a;
; char *b;
; void c() {
