...
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+zcheripurecap,+cap-mode,+f,+d -relocation-model=static < %s -o - | FileCheck %s
...
; CHECK-NEXT:    auipc ca2, %pcrel_hi(.LJTI2_0)
; CHECK-NEXT:    caddi ca2, ca2, %pcrel_lo(.LBB2_10)
