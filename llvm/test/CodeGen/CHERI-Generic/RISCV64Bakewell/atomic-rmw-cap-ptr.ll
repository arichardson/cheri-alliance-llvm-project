...
; PURECAP-LIBCALLS-NEXT:    call __atomic_exchange_8
...
; PURECAP-LIBCALLS-NEXT:    sc cra, 0(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_add_8
; PURECAP-LIBCALLS-NEXT:    lc cra, 0(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS-NEXT:    sc cra, 0(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_sub_8
; PURECAP-LIBCALLS-NEXT:    lc cra, 0(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS-NEXT:    sc cra, 0(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_and_8
; PURECAP-LIBCALLS-NEXT:    lc cra, 0(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS-NEXT:    sc cra, 0(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_nand_8
; PURECAP-LIBCALLS-NEXT:    lc cra, 0(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS-NEXT:    sc cra, 0(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_or_8
; PURECAP-LIBCALLS-NEXT:    lc cra, 0(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS-NEXT:    sc cra, 0(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_xor_8
; PURECAP-LIBCALLS-NEXT:    lc cra, 0(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS:       # %bb.0:
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, -80
...
; PURECAP-LIBCALLS-NEXT:    cmv cs1, ca0
; PURECAP-LIBCALLS-NEXT:    ld a1, 0(ca0)
...
; PURECAP-LIBCALLS-NEXT:    cmv ca0, cs1
...
; PURECAP-LIBCALLS:       # %bb.0:
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, -64
...
; PURECAP-LIBCALLS-NEXT:    flw fa0, 0(ca0)
; PURECAP-LIBCALLS-NEXT:    caddi ca0, csp, 4
...
; PURECAP-LIBCALLS-NEXT:    fsw fa0, 4(csp)
...
; PURECAP-LIBCALLS-NEXT:    flw fa0, 4(csp)
