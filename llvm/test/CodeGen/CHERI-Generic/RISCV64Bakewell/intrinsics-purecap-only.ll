...
; RUN: not --crash llc -mtriple=riscv64 --relocation-model=pic -target-abi lp64d -mattr=+zcheripurecap,+zcherihybrid,+f,+d < %s -o - 2>&1 | FileCheck %s --check-prefix HYBRID-ERROR
