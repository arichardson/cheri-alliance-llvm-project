...
; CHECK-NEXT:    auipc ca1, %pcrel_hi(constant_ptrs)
; CHECK-NEXT:    addi ca1, ca1, %pcrel_lo(.LBB3_1)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    auipc ca1, %pcrel_hi(constant_ptrs)
; CHECK-NEXT:    addi ca1, ca1, %pcrel_lo(.LBB4_1)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    auipc ca1, %pcrel_hi(constant_ptrs)
; CHECK-NEXT:    addi ca1, ca1, %pcrel_lo(.LBB8_1)
; CHECK-NEXT:    lc ca1, 0(ca1)
; CHECK-NEXT:    sc ca1, 0(ca0)
; CHECK-NEXT:    ret
do.body:
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    auipc ca1, %pcrel_hi(constant_ptrs)
; CHECK-NEXT:    addi ca1, ca1, %pcrel_lo(.LBB9_1)
; CHECK-NEXT:    lc ca1, 16(ca1)
; CHECK-NEXT:    sc ca1, 0(ca0)
; CHECK-NEXT:    ret
do.body:
