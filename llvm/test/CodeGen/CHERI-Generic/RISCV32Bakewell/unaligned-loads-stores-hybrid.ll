...
; CHECK-NEXT:    caddi ca4, ca2, 3
; CHECK-NEXT:    sb.cap a1, (ca3)
; CHECK-NEXT:    srli a1, a0, 24
; CHECK-NEXT:    caddi ca3, ca2, 2
; CHECK-NEXT:    sb.cap a1, (ca4)
; CHECK-NEXT:    srli a1, a0, 16
; CHECK-NEXT:    caddi ca2, ca2, 1
