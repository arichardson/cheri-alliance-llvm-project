...
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi ilp32f -mattr=+zcheripurecap,+zcherihybrid,+f %s -o - | FileCheck %s
...
; CHECK-NEXT:    j .LBB0_3
; CHECK-NEXT:  .LBB0_2:
; CHECK-NEXT:    scaddr ca1, ca1, a0
; CHECK-NEXT:  .LBB0_3:
; CHECK-NEXT:    lbu.cap a0, (ca1)
; CHECK-NEXT:    caddi ca2, ca1, 1
; CHECK-NEXT:    lbu.cap a2, (ca2)
; CHECK-NEXT:    caddi ca3, ca1, 2
; CHECK-NEXT:    lbu.cap a3, (ca3)
; CHECK-NEXT:    caddi ca4, ca1, 3
...
; CHECK-NEXT:    lbu.cap a2, (ca2)
; CHECK-NEXT:    caddi ca3, ca1, 5
; CHECK-NEXT:    lbu.cap a3, (ca3)
; CHECK-NEXT:    caddi ca4, ca1, 6
; CHECK-NEXT:    lbu.cap a4, (ca4)
; CHECK-NEXT:    caddi ca1, ca1, 7
...
; CHECK-NEXT:  # %bb.1:
; CHECK-NEXT:    cmv ca2, cnull
; CHECK-NEXT:    j .LBB4_3
; CHECK-NEXT:  .LBB4_2:
; CHECK-NEXT:    scaddr ca2, ca3, a2
; CHECK-NEXT:  .LBB4_3:
; CHECK-NEXT:    sb.cap a0, (ca2)
; CHECK-NEXT:    caddi ca3, ca2, 7
; CHECK-NEXT:    srli a4, a1, 24
; CHECK-NEXT:    sb.cap a4, (ca3)
; CHECK-NEXT:    caddi ca3, ca2, 6
; CHECK-NEXT:    srli a4, a1, 16
; CHECK-NEXT:    sb.cap a4, (ca3)
; CHECK-NEXT:    caddi ca3, ca2, 5
; CHECK-NEXT:    srli a4, a1, 8
; CHECK-NEXT:    sb.cap a4, (ca3)
; CHECK-NEXT:    caddi ca3, ca2, 4
; CHECK-NEXT:    sb.cap a1, (ca3)
; CHECK-NEXT:    caddi ca1, ca2, 3
; CHECK-NEXT:    srli a3, a0, 24
; CHECK-NEXT:    sb.cap a3, (ca1)
; CHECK-NEXT:    caddi ca1, ca2, 2
; CHECK-NEXT:    srli a3, a0, 16
; CHECK-NEXT:    sb.cap a3, (ca1)
; CHECK-NEXT:    caddi ca1, ca2, 1
