...
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+zcheripurecap,+cap-mode,+f %s -o - --stop-after=finalize-isel | FileCheck %s
...
define void @dynamic_alloca(i64 zeroext %n) {
  ...
  ; CHECK-NEXT:   [[AND1:%[0-9]+]]:gpr = AND killed [[SUB]], [[CRAM_]]
