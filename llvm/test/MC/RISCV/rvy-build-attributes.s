...
## NOTE: unlike upstream, this fork's C extension does not imply Zca, so the
## two expectations below lack the trailing _zca1p0 that upstream has.
## RV64Y + D + C: y is enabled, so zcd is not implied.
# RV64YDC: .attribute 5, "rv64i2p1_f2p2_d2p2_c2p0_y0p98_zicsr2p0"

## RV32Y + F + C: y is enabled, so zcf is not implied.
# RV32YFC: .attribute 5, "rv32i2p1_f2p2_c2p0_y0p98_zicsr2p0"
