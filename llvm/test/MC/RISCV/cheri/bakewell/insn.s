...
# RUN:     | llvm-objdump --no-print-imm-hex --mattr=+zcheripurecap,+zcherihybrid -M no-aliases -d -r - \
...
# .insn operands are untyped raw register numbers, so its own asm output
# always uses the plain name. The decoded disassembly below know these
# bytes really are a capability instruction.
# CHECK-ASM: .insn r 51, 0, 6, a0, a1, a2
...
# CHECK-ASM: .insn i 27, 2, a0, a1, 13
