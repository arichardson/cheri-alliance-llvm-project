...
# CHECK-OBJ: [[ADDR1:[0-9]+]] <$x<nocapmode>>:
# CHECK-OBJ: [[#LINE:]]: 000b4517   auipc   a0, 180
auipc a0, 180

# CHECK-MC: .option capmode
# CHECK-MC: auipc ca0, 180
# CHECK-OBJ: [[ADDR2:[0-9]+]] <$x<capmode>>:
# CHECK-OBJ: [[#LINE:]]: 000b4517   auipc   ca0, 180
.option capmode
auipc ca0, 180

# CHECK-MC: .option nocapmode
# CHECK-MC: auipc a0, 180
# CHECK-OBJ: [[ADDR3:[0-9]+]] <$x<nocapmode>>:
# CHECK-OBJ: [[#LINE:]]: 000b4517   auipc   a0, 180
.option nocapmode
auipc a0, 180
