...
# RUN:   | llvm-objdump --no-print-imm-hex  --triple=riscv32 --mattr=+c,+d,+zcheripurecap,+cap-mode -d - \
# RUN:   | FileCheck -check-prefixes=CHECK-BYTES,CHECK-ALIAS %s
# RUN: llvm-mc -triple riscv32 -mattr=+c,+d,+zcheripurecap,+cap-mode -filetype=obj < %s \
# RUN:   | llvm-objdump --no-print-imm-hex  --triple=riscv32 --mattr=+c,+d,+zcheripurecap,+cap-mode -d -M no-aliases - \
