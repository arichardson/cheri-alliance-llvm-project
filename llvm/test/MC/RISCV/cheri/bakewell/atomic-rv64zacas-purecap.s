...
# RUN: llvm-mc -filetype=obj -triple=riscv64 -mattr=+a,+zacas,+zcheripurecap,+zcherihybrid < %s \
# RUN:     | llvm-objdump --mattr=+a,+zacas,+zcheripurecap,+zcherihybrid,+cap-mode -M no-aliases -d -r - \
# RUN:     | FileCheck -check-prefixes=CHECK-ASM-AND-OBJ %s

# Tests instructions available in purecap + Zacas, rv64.
