...
; ENTRY: call void @llvm.instrprof.increment.p0(ptr @__profn_test_br_2, i64 {{[0-9]+}}, i32 2, i32 0)
...
if.then:
; GEN: if.then:
; NOTENTRY: call void @llvm.instrprof.increment.p0(ptr @__profn_test_br_2, i64 {{[0-9]+}}, i32 2, i32 0)
