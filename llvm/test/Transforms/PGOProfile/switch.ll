...
; ENTRY: call void @llvm.instrprof.increment.p0(ptr @__profn_test_switch, i64 {{[0-9]+}}, i32 4, i32 0)
...
sw.bb:
; GEN: sw.bb:
; GEN: call void @llvm.instrprof.increment.p0(ptr @__profn_test_switch, i64 {{[0-9]+}}, i32 4, i32 2)
  br label %sw.epilog

sw.bb1:
; GEN: sw.bb1:
; NOTENTRY: call void @llvm.instrprof.increment.p0(ptr @__profn_test_switch, i64 {{[0-9]+}}, i32 4, i32 0)
; ENTRY-NOT: call void @llvm.instrprof.increment
  br label %sw.epilog

sw.bb2:
; GEN: sw.bb2:
; GEN: call void @llvm.instrprof.increment.p0(ptr @__profn_test_switch, i64 {{[0-9]+}}, i32 4, i32 1)
  br label %sw.epilog

sw.default:
; GEN: sw.default:
; GEN: call void @llvm.instrprof.increment.p0(ptr @__profn_test_switch, i64 {{[0-9]+}}, i32 4, i32 3)
  br label %sw.epilog
