...
; COLD: call void @llvm.instrprof.cover.p0(ptr @__profn_foo, i64  [[#]], i32 1, i32 0)
; COLD-NOT: __profn_main
; COLD-NOT: __profn_bar

; ENTRY-COUNT: call void @llvm.instrprof.cover.p0(ptr @__profn_foo, i64  [[#]], i32 1, i32 0)
; ENTRY-COUNT: call void @llvm.instrprof.cover.p0(ptr @__profn_main, i64 [[#]], i32 1, i32 0)

; UNKNOWN-FUNC: call void @llvm.instrprof.cover.p0(ptr @__profn_bar, i64  [[#]], i32 1, i32 0)
; UNKNOWN-FUNC: call void @llvm.instrprof.cover.p0(ptr @__profn_foo, i64  [[#]], i32 1, i32 0)
