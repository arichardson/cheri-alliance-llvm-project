...
entry:
; GEN: entry:
; GEN: call void @llvm.instrprof.increment.p0(ptr @__profn_test_br_1, i64 {{[0-9]+}}, i32 2, i32 0)
...
if.then:
; GEN: if.then:
; GEN: call void @llvm.instrprof.increment.p0(ptr @__profn_test_br_1, i64 {{[0-9]+}}, i32 2, i32 1)
  %add = add nsw i32 %i, 2
  br label %if.end
