...
define hidden fastcc noundef nonnull align 4 ptr addrspace(200) @_RNvMCs2LzHmOg8pe3_8iter_revNtB2_8Big32x408mul_pow2(ptr addrspace(200) %self, i32 noundef signext %bits) unnamed_addr addrspace(200) #0 {
start:
...
panic:                                            ; preds = %bb1
  tail call addrspace(200) void @_RNvNtCsHqy3LjcUoC_4core9panicking18panic_bounds_check(i32 noundef signext %_11, i32 noundef signext 40, ptr addrspace(200) @alloc_9588fd9eb89b71aecf86d2ab3280d014) #2
  unreachable
...
panic2:                                           ; preds = %bb3
  tail call addrspace(200) void @_RNvNtCsHqy3LjcUoC_4core9panicking18panic_bounds_check(i32 noundef signext %1, i32 noundef signext 40, ptr addrspace(200) @alloc_45c28facb1bb8016d3ea9e1d6f907c1e) #2
  unreachable

bb8:                                              ; preds = %bb14, %bb5
  %_26 = phi i32 [ %_10, %bb5 ], [ %_29, %bb14 ]
  %iter.sroa.4.0 = phi i32 [ %1, %bb5 ], [ %_0.i1.i.i.i, %bb14 ]
  %_0.i.i.i.i = icmp ult i32 %_19, %iter.sroa.4.0
...
panic3:                                           ; preds = %bb12
  tail call addrspace(200) void @_RNvNtCsHqy3LjcUoC_4core9panicking18panic_bounds_check(i32 noundef signext %digits11, i32 noundef signext 40, ptr addrspace(200) @alloc_a9c4d6ab0ff0d6fb90dda7bf52fd7aca) #2
  unreachable
...
panic5:                                           ; preds = %bb13
  tail call addrspace(200) void @_RNvNtCsHqy3LjcUoC_4core9panicking18panic_bounds_check(i32 noundef signext -1, i32 noundef signext 40, ptr addrspace(200) @alloc_6d4cd78cee70c5eec05fa83141d7b53c) #2
  unreachable
}

; Function Attrs: cold minsize noinline noreturn nounwind optsize
declare dso_local void @_RNvNtCsHqy3LjcUoC_4core9panicking18panic_bounds_check(i32 noundef signext, i32 noundef signext, ptr addrspace(200)) unnamed_addr addrspace(200) #1
