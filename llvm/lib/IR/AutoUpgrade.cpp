...
static bool upgradeArmOrAarch64IntrinsicFunction(bool IsArm, Function *F,
  ...
  if (Name == "thread.pointer") {
    ...
    NewFn = Intrinsic::getOrInsertDeclaration(F->getParent(), Intrinsic::thread_pointer,
                                              F->getReturnType());
    return true;
  }
...
static bool upgradeIntrinsicFunction1(Function *F, Function *&NewFn,
  ...
  case 'a': {
    ...
    if (Name == "annotation") {
      ...
      NewFn = Intrinsic::getOrInsertDeclaration(F->getParent(), Intrinsic::annotation, Tys);
      return true;
    }
  ...
  case 'f':
    if (Name.starts_with("flt.rounds")) {
      ...
      NewFn = Intrinsic::getOrInsertDeclaration(F->getParent(), Intrinsic::frameaddress,
                                                F->getReturnType());
      return true;
    }
    break;
  ...
  case 's':
    ...
    if (Name == "stacksave") {
      NewFn = Intrinsic::getOrInsertDeclaration(F->getParent(), Intrinsic::stacksave,
                                                F->getReturnType());
      return true;
    }
    if (Name == "stackrestore") {
      auto *ArgTy = F->arg_begin()->getType();
      NewFn = Intrinsic::getOrInsertDeclaration(F->getParent(), Intrinsic::stackrestore,
                                                ArgTy);
      return true;
    }
    break;
  ...
  case 'v': {
    ...
    if (Name == "va_start") {
      NewFn = Intrinsic::getOrInsertDeclaration(F->getParent(), Intrinsic::vastart,
                                                ArgTy);
      return true;
    }
    if (Name == "va_end") {
      NewFn = Intrinsic::getOrInsertDeclaration(F->getParent(), Intrinsic::vaend,
                                                ArgTy);
      return true;
    }
    if (Name == "va_copy") {
      NewFn = Intrinsic::getOrInsertDeclaration(F->getParent(), Intrinsic::vacopy,
                                                { ArgTy });
      return true;
    }
