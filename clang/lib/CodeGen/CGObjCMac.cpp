...
ObjCTypesHelper::ObjCTypesHelper(CodeGen::CodeGenModule &cgm)
  ...
  ProtocolTy = llvm::StructType::create(
      {ProtocolExtensionPtrTy, Int8PtrTy,
       llvm::PointerType::get(VMContext, DefaultAS), MethodDescriptionListPtrTy,
       MethodDescriptionListPtrTy},
      "struct._objc_protocol");

  ProtocolListTy =
      llvm::StructType::create({llvm::PointerType::get(VMContext, DefaultAS), LongTy,
  ...
  ClassTy = llvm::StructType::create(
      {llvm::PointerType::get(VMContext, DefaultAS),
       llvm::PointerType::get(VMContext, DefaultAS), Int8PtrTy, LongTy, LongTy,
...
ObjCNonFragileABITypesHelper::ObjCNonFragileABITypesHelper(CodeGen::CodeGenModule &cgm)
  ...
  ProtocolnfABITy = llvm::StructType::create(
      ...
      llvm::PointerType::get(VMContext, DefaultAS), MethodListnfABIPtrTy,
  ...
  // ImpnfABITy - LLVM for id (*)(id, SEL, ...)
  llvm::Type *params[] = { ObjectPtrTy, SelectorPtrTy };
  ImpnfABITy = llvm::PointerType::get(llvm::FunctionType::get(ObjectPtrTy, params, false),
  ...
  ClassnfABITy = llvm::StructType::create(
      {llvm::PointerType::get(VMContext, DefaultAS),
       llvm::PointerType::get(VMContext, DefaultAS), CachePtrTy,
