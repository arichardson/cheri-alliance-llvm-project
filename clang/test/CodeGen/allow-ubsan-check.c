...
// CHECK-NEXT:    [[TMP2:%.*]] = call i1 @llvm.allow.ubsan.check(i8 73), !nosanitize [[META2]]
...
// TR-NEXT:    [[TMP2:%.*]] = call i1 @llvm.allow.ubsan.check(i8 73), !nosanitize [[META2]]
...
// TR:       [[TRAP]]:
// TR-NEXT:    call void @llvm.ubsantrap(i8 73) #[[ATTR5]], !nosanitize [[META2]]
// TR-NEXT:    unreachable, !nosanitize [[META2]]
//
...
// REC-NEXT:    [[TMP2:%.*]] = call i1 @llvm.allow.ubsan.check(i8 73), !nosanitize [[META2]]
