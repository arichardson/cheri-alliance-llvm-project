...
// RUN: %riscv64_bakewell_purecap_cc1 %s -o - -emit-llvm -O1 -Weverything -Werror -Wno-declaration-after-statement -Wno-pre-c11-compat -verify
// RUN: %riscv64_bakewell_purecap_cc1 -target-feature +zcherilevels %s -o - -emit-llvm -O1 -Weverything -Werror -Wno-declaration-after-statement -Wno-pre-c11-compat -verify
