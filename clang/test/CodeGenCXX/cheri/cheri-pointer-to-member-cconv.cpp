...
// RISCV64-PURECAP-SAME: (ptr addrspace(200) dead_on_unwind noalias nocapture writable writeonly sret({ ptr addrspace(200), i64 }) align 16 initializes((0, 32)) [[AGG_RESULT:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR0:[0-9]+]] {
// RISCV64-PURECAP-NEXT:  entry:
// RISCV64-PURECAP-NEXT:    store { ptr addrspace(200), i64 } { ptr addrspace(200) @_ZN1A3fooEv, i64 0 }, ptr addrspace(200) [[AGG_RESULT]], align 16, !tbaa [[TBAA6:![0-9]+]]
...
// RISCV64-PURECAP-SAME: (ptr addrspace(200) dead_on_unwind noalias nocapture writable writeonly sret({ ptr addrspace(200), i64 }) align 16 initializes((0, 32)) [[AGG_RESULT:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR0]] {
// RISCV64-PURECAP-NEXT:  entry:
...
// RISCV64-PURECAP-SAME: (ptr addrspace(200) dead_on_unwind noalias nocapture writable writeonly sret({ ptr addrspace(200), i64 }) align 16 initializes((0, 32)) [[AGG_RESULT:%.*]], ptr addrspace(200) nocapture noundef readonly [[TMP0:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR2:[0-9]+]] {
// RISCV64-PURECAP-NEXT:  entry:
